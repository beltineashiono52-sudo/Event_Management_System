...
const StudentDashboard = () => {
    ...
    const [loadingId, setLoadingId] = useState(null); // event id being registered
    ...
    const loadAll = async () => {
        try {
            ...
            // regRes.data is an array of event_ids
    ...
    const handleRegister = async (event) => {
        ...
        try {
            if (registeredIds.has(event.id)) {
                ...
                loadNotifications(); // refresh notifications to show confirmation notif
            }
        } catch (err) {
    ...
    const typeBadgeColour = { social: 'primary', fundraiser: 'success', workshop: 'info', other: 'secondary' };
